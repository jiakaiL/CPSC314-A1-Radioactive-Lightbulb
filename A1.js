...
var newlightPosition = {type: 'v3', value: new THREE.Vector3(7,1,0)};
...
var newlightbulbMaterial = new THREE.ShaderMaterial({
   uniforms: {
    newlightPosition: newlightPosition,
    lightPosition: lightPosition,
  },
});
...
var shaderFiles = [
  ...
  'glsl/newlightbulb.vs.glsl',
  'glsl/newlightbulb.fs.glsl'
];
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
  ...
  newlightbulbMaterial.vertexShader = shaders['glsl/newlightbulb.vs.glsl'];
  newlightbulbMaterial.fragmentShader = shaders['glsl/newlightbulb.fs.glsl'];
})
...
// New light 
var newlightGeo = new THREE.SphereGeometry(1,32,32);
var newlightbulb = new THREE.Mesh(newlightGeo,newlightbulbMaterial);
newlightbulb.parent = worldFrame;
scene.add(newlightbulb);
...
function checkKeyboard() {
  ...
  newlightbulbMaterial.needsUpdate = true;
}
